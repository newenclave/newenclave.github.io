...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zo(e,t,n){let r=new Float32Array(Lo),i=new V(0,1,0);return new ga({name:`SphericalGaussianBlur`,defines:{n:Lo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:es(),fragmentShader:`
	...
	`}var ts=class extends Rt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new qi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ec={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Dc(e,t){let n=Ec[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Oc=new V;function kc(){return U.getLuminanceCoefficients(Oc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Oc.x.toFixed(4)}, ${Oc.y.toFixed(4)}, ${Oc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=vc(i,i.VERTEX_SHADER,y),S=vc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=wc(i,x,`vertex`),n=wc(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,Al=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Zi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new ga({vertexShader:Ol,fragmentShader:kl,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new oi(new ia(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},jl=class extends ut{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,m=typeof XRWebGLBinding<`u`,h=new Al,g={},v=t.getContextAttributes(),y=null,b=null,x=[],C=[],w=new B,T=null,E=new Ja;E.viewport=new It;let O=new Ja;O.viewport=new It;let k=[E,O],A=new no,ee=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=x[e];return t===void 0&&(t=new vn,x[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=x[e];return t===void 0&&(t=new vn,x[e]=t),t.getGripSpace()},this.getHand=function(e){let t=x[e];return t===void 0&&(t=new vn,x[e]=t),t.getHandSpace()};function ie(e){let t=C.indexOf(e.inputSource);if(t===-1)return;let n=x[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,ie),r.removeEventListener(`selectstart`,ie),r.removeEventListener(`selectend`,ie),r.removeEventListener(`squeeze`,ie),r.removeEventListener(`squeezestart`,ie),r.removeEventListener(`squeezeend`,ie),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<x.length;e++){let t=C[e];t!==null&&(C[e]=null,x[e].disconnect(t))}ee=null,re=null,h.reset();for(let e in g)delete g[e];e.setRenderTarget(y),f=null,d=null,u=null,r=null,b=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(T),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&m&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(y=e.getRenderTarget(),r.addEventListener(`select`,ie),r.addEventListener(`selectstart`,ie),r.addEventListener(`selectend`,ie),r.addEventListener(`squeeze`,ie),r.addEventListener(`squeezestart`,ie),r.addEventListener(`squeezeend`,ie),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),v.xrCompatible!==!0&&await t.makeXRCompatible(),T=e.getPixelRatio(),e.getSize(w),m&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;v.depth&&(o=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=v.stencil?ne:j,a=v.stencil?D:S);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),b=new Rt(d.textureWidth,d.textureHeight,{format:te,type:_,depthTexture:new Yi(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),b=new Rt(f.framebufferWidth,f.framebufferHeight,{format:te,type:_,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return h.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=C.indexOf(n);r>=0&&(C[r]=null,x[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=C.indexOf(n);if(r===-1){for(let e=0;e<x.length;e++)if(e>=C.length){C.push(n),r=e;break}else if(C[e]===null){C[e]=n,r=e;break}if(r===-1)break}let i=x[r];i&&i.connect(n)}}let se=new V,ce=new V;function le(e,t,n){se.setFromMatrixPosition(t.matrixWorld),ce.setFromMatrixPosition(n.matrixWorld);let r=se.distanceTo(ce),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ue(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;h.texture!==null&&(h.depthNear>0&&(t=h.depthNear),h.depthFar>0&&(n=h.depthFar)),A.near=O.near=E.near=t,A.far=O.far=E.far=n,(ee!==A.near||re!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),ee=A.near,re=A.far),A.layers.mask=e.layers.mask|6,E.layers.mask=A.layers.mask&-5,O.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;ue(A,i);for(let e=0;e<a.length;e++)ue(a[e],i);a.length===2?le(A,E,O):A.projectionMatrix.copy(E.projectionMatrix),de(e,A,i)};function de(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=pt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(d!==null||f!==null)return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return h.texture!==null},this.getDepthSensingMesh=function(){return h.getMesh(A)},this.getCameraTexture=function(e){return g[e]};let M=null;function fe(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(b,f.framebuffer),e.setRenderTarget(b));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(b,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(b))}let o=k[n];o===void 0&&(o=new Ja,o.layers.enable(n),o.viewport=new It,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&m){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&h.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&m){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=g[n];e||(e=new Zi,g[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<x.length;e++){let t=C[e],n=x[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}M&&M(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let pe=new wo;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){M=e},this.dispose=function(){}}},Ml=new Vt,Nl=new H;Nl.set(-1,0,0,0,1,0,0,0,1);function Pl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,fa(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Ml.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Nl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Fl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var Il=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ll=null;function Rl(){return Ll===null&&(Ll=new li(Il,16,16,ae,w),Ll.name=`DFG_LUT`,Ll.minFilter=m,Ll.magFilter=m,Ll.wrapS=l,Ll.wrapT=l,Ll.generateMipmaps=!1,Ll.needsUpdate=!0),Ll}var zl=class{constructor(e={}){let{canvas:t=rt(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=_}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);p=n.getContextAttributes().alpha}else p=a;let m=f,h=new Set([se,oe,ie]),v=new Set([_,S,b,D,T,E]),y=new Uint32Array(4),x=new Int32Array(4),C=new V,O=null,k=null,A=[],ee=[],te=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ne=!1,re=null,ae=null,ce=null,le=null;this._outputColorSpace=qe;let ue=0,de=0,M=null,fe=-1,pe=null,me=new It,he=new It,ge=null,_e=new W(0),ve=0,ye=t.width,be=t.height,xe=1,Se=null,Ce=null,we=new It(0,0,ye,be),Te=new It(0,0,ye,be),Ee=!1,De=new Ei,Oe=!1,ke=!1,Ae=new Vt,je=new V,Me=new It,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pe=!1;function Fe(){return M===null?xe:1}let N=n;function Ie(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,ut,!1),t.addEventListener(`webglcontextrestored`,dt,!1),t.addEventListener(`webglcontextcreationerror`,ft,!1),N===null){let t=`webgl2`;if(N=Ie(t,e),N===null)throw Ie(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Le,Re,P,ze,F,I,Be,Ve,He,Ue,We,Ge,Ke,Je,Ye,Xe,Ze,Qe,et,tt,nt,it,ot;function st(){Le=new rs(N),Le.init(),nt=new Dl(N,Le),Re=new No(N,Le,e,nt),P=new Tl(N,Le),Re.reversedDepthBuffer&&d&&P.buffers.depth.setReversed(!0),ae=N.createFramebuffer(),ce=N.createFramebuffer(),le=N.createFramebuffer(),ze=new os(N),F=new al,I=new El(N,Le,P,F,Re,nt,ze),Be=new ns(j),Ve=new To(N),it=new jo(N,Ve),He=new is(N,Ve,ze,it),Ue=new cs(N,He,Ve,it,ze),Qe=new ss(N,Re,I),Ye=new Po(F),We=new il(j,Be,Le,Re,it,Ye),Ge=new Pl(j,F),Ke=new ll,Je=new gl(Le),Ze=new Ao(j,Be,P,Ue,p,s),Xe=new wl(j,Ue,Re),ot=new Fl(N,ze,Re,P),et=new Mo(N,Le,ze),tt=new as(N,Le,ze),ze.programs=We.programs,j.capabilities=Re,j.extensions=Le,j.properties=F,j.renderLists=Ke,j.shadowMap=Xe,j.state=P,j.info=ze}st(),m!==1009&&(te=new us(m,t.width,t.height,o,r,i));let lt=new jl(j,N);this.xr=lt,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return xe},this.setPixelRatio=function(e){e!==void 0&&(xe=e,this.setSize(ye,be,!1))},this.getSize=function(e){return e.set(ye,be)},this.setSize=function(e,n,r=!0){if(lt.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ye=e,be=n,t.width=Math.floor(e*xe),t.height=Math.floor(n*xe),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),te!==null&&te.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ye*xe,be*xe).floor()},this.setDrawingBufferSize=function(e,n,r){ye=e,be=n,xe=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(m===1009){R(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}te.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(me)},this.getViewport=function(e){return e.copy(we)},this.setViewport=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),P.viewport(me.copy(we).multiplyScalar(xe).round())},this.getScissor=function(e){return e.copy(Te)},this.setScissor=function(e,t,n,r){e.isVector4?Te.set(e.x,e.y,e.z,e.w):Te.set(e,t,n,r),P.scissor(he.copy(Te).multiplyScalar(xe).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(e){P.setScissorTest(Ee=e)},this.setOpaqueSort=function(e){Se=e},this.setTransparentSort=function(e){Ce=e},this.getClearColor=function(e){return e.copy(Ze.getClearColor())},this.setClearColor=function(){Ze.setClearColor(...arguments)},this.getClearAlpha=function(){return Ze.getClearAlpha()},this.setClearAlpha=function(){Ze.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=h.has(t)}if(e){let e=M.texture.type,t=v.has(e),n=Ze.getClearColor(),r=Ze.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(y[0]=i,y[1]=a,y[2]=o,y[3]=r,N.clearBufferuiv(N.COLOR,0,y)):(x[0]=i,x[1]=a,x[2]=o,x[3]=r,N.clearBufferiv(N.COLOR,0,x))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),re=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,ut,!1),t.removeEventListener(`webglcontextrestored`,dt,!1),t.removeEventListener(`webglcontextcreationerror`,ft,!1),Ze.dispose(),Ke.dispose(),Je.dispose(),F.dispose(),Be.dispose(),Ue.dispose(),it.dispose(),ot.dispose(),We.dispose(),lt.dispose(),lt.removeEventListener(`sessionstart`,vt),lt.removeEventListener(`sessionend`,B),yt.stop()};function ut(e){e.preventDefault(),at(`WebGLRenderer: Context Lost.`),ne=!0}function dt(){at(`WebGLRenderer: Context Restored.`),ne=!1;let e=ze.autoReset,t=Xe.enabled,n=Xe.autoUpdate,r=Xe.needsUpdate,i=Xe.type;st(),ze.autoReset=e,Xe.enabled=t,Xe.autoUpdate=n,Xe.needsUpdate=r,Xe.type=i}function ft(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function pt(e){let t=e.target;t.removeEventListener(`dispose`,pt),mt(t)}function mt(e){z(e),F.remove(e)}function z(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){We.releaseProgram(e)}),e.isShaderMaterial&&We.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ne);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ot(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=He.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;it.setup(i,r,s,n,c);let h,g=et;if(c!==null&&(h=Ve.get(c),g=tt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Fe()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Fe()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh){if(Le.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ve.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ht(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,wt(e,t,n),e.side=0,e.needsUpdate=!0,wt(e,t,n),e.side=2):wt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Je.get(n),k.init(t),ee.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t){if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ht(a,n,e),r.add(a)}else ht(t,n,e),r.add(t)}}),k=ee.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Le.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let gt=null;function _t(e){gt&&gt(e)}function vt(){yt.stop()}function B(){yt.start()}let yt=new wo;yt.setAnimationLoop(_t),typeof self<`u`&&yt.setContext(self),this.setAnimationLoop=function(e){gt=e,lt.setAnimationLoop(e),e===null?yt.stop():yt.start()},lt.addEventListener(`sessionstart`,vt),lt.addEventListener(`sessionend`,B),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ne===!0)return;re!==null&&re.renderStart(e,t);let n=lt.enabled===!0&&lt.isPresenting===!0,r=te!==null&&(M===null||n)&&te.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),lt.enabled===!0&&lt.isPresenting===!0&&(te===null||te.isCompositing()===!1)&&(lt.cameraAutoUpdate===!0&&lt.updateCamera(t),t=lt.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),k=Je.get(e,ee.length),k.init(t),k.state.textureUnits=I.getTextureUnits(),ee.push(k),Ae.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),De.setFromProjectionMatrix(Ae,$e,t.reversedDepth),ke=this.localClippingEnabled,Oe=Ye.init(this.clippingPlanes,ke),O=Ke.get(e,A.length),O.init(),A.push(O),lt.enabled===!0&&lt.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&bt(e,t,-1/0,j.sortObjects)}bt(e,t,0,j.sortObjects),O.finish(),j.sortObjects===!0&&O.sort(Se,Ce,t.reversedDepth),Pe=lt.enabled===!1||lt.isPresenting===!1||lt.hasDepthSensing()===!1,Pe&&Ze.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Oe===!0&&Ye.beginShadows();let i=k.state.shadowsArray;if(Xe.render(i,e,t),Oe===!0&&Ye.endShadows(),(r&&te.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];H(n,r,e,a)}Pe&&Ze.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];xt(O,e,n,n.viewport)}}else r.length>0&&H(n,r,e,t),Pe&&Ze.render(e),xt(O,e,t)}M!==null&&de===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&te.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),it.resetDefaultState(),fe=-1,pe=null,ee.pop(),ee.length>0?(k=ee[ee.length-1],I.setTextureUnits(k.state.textureUnits),Oe===!0&&Ye.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),O=A.length>0?A[A.length-1]:null,re!==null&&re.renderEnd()};function bt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||De.intersectsSprite(e)){r&&Me.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ae);let t=Ue.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Me.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||De.intersectsObject(e))){let t=Ue.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Me.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Me.copy(e.boundingSphere.center)),Me.applyMatrix4(e.matrixWorld).applyMatrix4(Ae)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Me.z,o)}}else i.visible&&O.push(e,t,i,n,Me.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)bt(i[e],t,n,r)}function xt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Oe===!0&&Ye.setGlobalState(j.clippingPlanes,n),r&&P.viewport(me.copy(r)),i.length>0&&St(i,t,n),a.length>0&&St(a,t,n),o.length>0&&St(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function H(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Le.has(`EXT_color_buffer_half_float`)||Le.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Rt(1,1,{generateMipmaps:!0,type:e?w:_,minFilter:g,samples:Math.max(4,Re.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:U.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||me;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),c=j.getActiveCubeFace(),l=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(_e),ve=j.getClearAlpha(),ve<1&&j.setClearColor(16777215,.5),j.clear(),Pe&&Ze.render(n);let u=j.toneMapping;j.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Oe===!0&&Ye.setGlobalState(j.clippingPlanes,r),St(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Le.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Ct(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,c,l),j.setClearColor(_e,ve),d!==void 0&&(r.viewport=d),j.toneMapping=u}function St(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Ct(o,t,n,s,l,c)}}function Ct(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function wt(e,t,n){t.isScene!==!0&&(t=Ne);let r=F.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=We.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=We.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Be.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,pt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Et(e,s),d}else s.uniforms=We.getUniforms(e),re!==null&&e.isNodeMaterial&&re.build(e,n,s),e.onBeforeCompile(s,j),d=We.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ye.uniform),Et(e,s),r.needsLights=At(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Tt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=_c.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Et(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Dt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];C.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(C))return n}return null}function Ot(e,t,n,r,i){t.isScene!==!0&&(t=Ne),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:U.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Be.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=k.state.lights;if(Oe===!0&&(ke===!0||e!==pe)){let t=e===pe&&r.id===fe;Ye.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ye.numPlanes||v.numIntersection!==Ye.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=wt(r,t,i),re&&r.isNodeMaterial&&re.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==fe&&(fe=r.id,C=!0),v.needsLights){let e=Dt(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||pe!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,je.setFromMatrixPosition(e.matrixWorld)),Re.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),pe!==e&&(pe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Qe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Rl()),C){if(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&kt(E,w),a&&r.fog===!0&&Ge.refreshFogUniforms(E,a),Ge.refreshMaterialUniforms(E,r,xe,be,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}_c.upload(N,Tt(v),E,I)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(_c.upload(N,Tt(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];ot.update(n,x),ot.bind(n,x)}}return x}function kt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function At(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ue},this.getActiveMipmapLevel=function(){return de},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){M=e,ue=t,de=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest,P.viewport(me),P.scissor(he),P.setScissorTest(ge),fe=-1;return}if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest}else me.copy(we).multiplyScalar(xe).floor(),he.copy(Te).multiplyScalar(xe).floor(),ge=Ee;if(n!==0&&(r=ae),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(me),P.scissor(he),P.setScissorTest(ge),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}fe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Re.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,nt.convert(c),nt.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Re.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,nt.convert(l),nt.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await ct(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=nt.convert(t.format),_=nt.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),P.activeTexture(N.TEXTURE0),P.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(N.UNPACK_ROW_LENGTH),b=P.getParameter(N.UNPACK_IMAGE_HEIGHT),x=P.getParameter(N.UNPACK_SKIP_PIXELS),S=P.getParameter(N.UNPACK_SKIP_ROWS),C=P.getParameter(N.UNPACK_SKIP_IMAGES);P.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(N.UNPACK_SKIP_PIXELS,l),P.pixelStorei(N.UNPACK_SKIP_ROWS,u),P.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,ce),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,le);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(N.UNPACK_ROW_LENGTH,y),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(N.UNPACK_SKIP_PIXELS,x),P.pixelStorei(N.UNPACK_SKIP_ROWS,S),P.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ue=0,de=0,M=null,P.reset(),it.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return $e}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=U._getDrawingBufferColorSpace(e),t.unpackColorSpace=U._getUnpackColorSpace()}},Bl=[14252152,16049057,9288948],Vl=5857645;function Hl(e,t,n){return new V(e,n,-t)}function Ul(e,t){return new W(e?`#${Math.round(e).toString(16).padStart(6,`0`)}`:t)}function Wl(e){return[`hosted`,`detached bound`,`roaming`,`destroyed`][Math.trunc(e)]||`unknown`}function Gl(e,t,n){return{lifecycle:Wl(e.stations[t+7]),hostBodyId:e.stationHostBodyIds[n]===4294967295?null:e.stationHostBodyIds[n],velocity:[e.stations[t+4],e.stations[t+5],e.stations[t+6]],orbitRadius:e.stations[t+8],direction:Math.trunc(e.stations[t+9]),distress:e.stations[t+10]!==0,orbitNormal:[e.stations[t+11],e.stations[t+12],e.stations[t+13]]}}function Kl(e,t){let n=Math.hypot(...t);return n>1e-12?[e[0]+t[0]/n*4,e[1]+t[1]/n*4,e[2]+t[2]/n*4]:e}function ql(e,t,n,r){let i=new V(...e).sub(t),a=new V(...n).normalize();if(i.lengthSq()<1e-12||a.lengthSq()<1e-12)return[];i.normalize().multiplyScalar(r);let o=new V().crossVectors(a,i).normalize().multiplyScalar(r),s=[];for(let e=0;e<33;e++){let n=e/32*Math.PI*2;s.push(Hl(...t.clone().addScaledVector(i,Math.cos(n)).addScaledVector(o,Math.sin(n))))}return s}function Jl(e,t,n,r,i){let a=0;for(let o=0;o<r.length;o+=i){if(r[o+3]!==0||r[o+8]<=0)continue;let i=e-r[o],s=t-r[o+1],c=n-r[o+2];i*i+s*s+c*c<=r[o+8]**2&&(a=Math.max(a,r[o+9]))}return a}function Yl(e,t,n,r,i,a){let o,s,c,l,u,d,f=localStorage.getItem(`multiverse-view`)!==`2d`,p=localStorage.getItem(`multiverse-grid`)!==`off`,m=[`far`,`medium`,`close`].includes(localStorage.getItem(`multiverse-camera`))?localStorage.getItem(`multiverse-camera`):`far`,h=null,g=null,_=[],v=[],y=null,b=null,x=new V,S=12,C=160,w=null,T=null,E=null,D=null,O=new Map,k=null,A=!1;function ee(){if(s){for(let e of[...s.children])e.traverse(e=>{e.geometry?.dispose(),(Array.isArray(e.material)?e.material:e.material?[e.material]:[]).forEach(e=>{e.map?.dispose(),e.dispose()})}),s.remove(e);v=[],_=[],y=null,b=null,g=null,T=null,D=null}}function te(e){let t=new gn,n=new oi(new ea(1.15,3.4,4),new Jr({color:7066597}));n.rotation.x=-Math.PI/2,t.add(n);let r=new oi(new oa(.42,10,8),new Jr({color:16036959}));r.position.z=1.55,t.add(r);let i=new oi(new Qi(2.8,.12,.65),new Jr({color:3233132}));return i.position.z=.5,t.add(i),t.rotation.order=`YXZ`,t.position.copy(e),t}function j(){!T||!s||(T.traverse(e=>{e.geometry?.dispose(),(Array.isArray(e.material)?e.material:e.material?[e.material]:[]).forEach(e=>e.dispose())}),s.remove(T),T=null,u&&(u.dataset.uShiftShellCount=`0`))}function ne(){if(!(!w||!s||!d||d.active)){j(),T=new gn,T.position.copy(Hl(d.ex.playerX(),d.ex.playerY(),d.ex.playerZ()));for(let e=0;e<4;e++){let t=new Jr({color:w.color,wireframe:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1,toneMapped:!1,fog:!1}),n=new oi(new na(1,2),t);n.userData.shiftIndex=e,T.add(n)}s.add(T),u.dataset.uShiftShellCount=String(T.children.length)}}function re(e=performance.now()){if(!w)return;let t=(e-w.startedAt)/w.duration;if(t>=1){j(),w=null,u&&(u.dataset.uShiftEffect=`idle`);return}if(T||ne(),T){T.rotation.y=w.direction*t*1.8,T.rotation.x=t*.7;for(let e of T.children){let n=e.userData.shiftIndex*.1,r=Math.max(0,Math.min(1,(t-n)/(1-n)));e.scale.setScalar(1.5+w.radius*r),e.material.opacity=t<n?0:(1-r)*(.68-e.userData.shiftIndex*.1),e.rotation.z=w.direction*r*(e.userData.shiftIndex+1)*.45}}}function ie(e){!f||!o||!s||!d||d.active||!Number.isFinite(e)||e===0||(w={startedAt:performance.now(),duration:1100,direction:Math.sign(e),radius:Math.min(70,20+Math.log2(1+Math.abs(e))*7),color:e>0?7066597:16036959},u.dataset.uShiftEffect=e>0?`forward`:`backward`,u.dataset.uShiftLastEffect=u.dataset.uShiftEffect,u.dataset.uShiftMagnitude=String(Math.abs(e)),ne(),re(),o.render(s,c))}function ae(){!D||!s||(D.traverse(e=>{e.geometry?.dispose(),(Array.isArray(e.material)?e.material:e.material?[e.material]:[]).forEach(e=>e.dispose())}),s.remove(D),D=null,u&&(u.dataset.scanRingCount=`0`))}function oe(){if(!(!E||!s||!d||d.active)){ae(),D=new gn,D.position.copy(Hl(d.ex.playerX(),d.ex.playerY(),d.ex.playerZ()));for(let e=0;e<3;e++){let t=new Jr({color:11599722,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!1,toneMapped:!1,fog:!1,side:2}),n=new oi(new aa(.982,1,96),t);n.rotation.x=-Math.PI/2,n.userData.scanIndex=e,D.add(n)}s.add(D),u.dataset.scanRingCount=String(D.children.length)}}function se(e=performance.now()){if(!E)return;let t=(e-E.startedAt)/E.duration;if(t>=1){ae(),E=null,u&&(u.dataset.scanEffect=`idle`);return}if(D||oe(),D){u.dataset.scanPhase=t<.55?`outbound`:`echo`;for(let e of D.children){let n=e.userData.scanIndex*.06,r=Math.max(0,Math.min(1,(t-n)/(1-n)));e.visible=t>=n;let i=r>.55,a=i?1-(r-.55)/.45:r/.55;e.scale.setScalar(2+E.radius*Math.max(0,a)),e.material.color.setHex(i?16036959:11599722),e.material.opacity=e.visible?Math.sin(Math.PI*r)*(.9-e.userData.scanIndex*.15):0}}}function ce(e){!f||!o||!s||!d||d.active||!Number.isFinite(e)||e<=0||(E={startedAt:performance.now(),duration:820,radius:e},u.dataset.scanEffect=`radar-echo`,u.dataset.scanLastEffect=u.dataset.scanEffect,u.dataset.scanGeometry=`planar`,u.dataset.scanPhase=`outbound`,u.dataset.scanDuration=String(E.duration),oe(),se(),o.render(s,c))}function le(){return new V(Math.cos(d.flight.heading)*Math.cos(d.flight.pitch),Math.sin(d.flight.pitch),-Math.sin(d.flight.heading)*Math.cos(d.flight.pitch))}function ue(){if(!d||!g)return;let e=Hl(d.ex.playerX(),d.ex.playerY(),d.ex.playerZ());g.position.copy(e),b&&b.position.copy(e),g.rotation.y=d.flight.heading-Math.PI/2,g.rotation.x=d.flight.pitch,g.rotation.z=d.flight.roll;let t=`${d.ex.playerX().toFixed(3)},${d.ex.playerY().toFixed(3)},${d.ex.playerZ().toFixed(3)}`;u.dataset.shipXYZ=t,u.dataset.queryXYZ=t}function de(){if(!g||d.flight.mode!==`nms`)return;let e=le(),t={far:1,medium:.5,close:.18}[m],n=Math.max(36,d.viewRange*1.35)*t,r=Math.max(14,d.zRange*.75)*t;c.position.copy(g.position).addScaledVector(e,-n).add(new V(0,r,0)),x.copy(g.position).addScaledVector(e,Math.min(12,d.viewRange*.12)),u.dataset.cameraPreset=m,u.dataset.cameraDistance=String(c.position.distanceTo(g.position)),c.lookAt(x)}function M(e){if([`far`,`medium`,`close`].includes(e)){m=e,localStorage.setItem(`multiverse-camera`,m);for(let e of r)e.setAttribute(`aria-pressed`,String(e.dataset.cameraDistance===m));if(!(!d||d.active||!o)){if(d.flight.mode===`nms`)de();else{let e={far:1,medium:.5,close:.18}[m],t=Math.hypot(Math.max(36,d.viewRange*1.35),Math.max(14,d.zRange*.75))*e,n=c.position.clone().sub(x);n.lengthSq()===0&&n.set(1,.75,1),c.position.copy(x).add(n.setLength(t)),c.lookAt(x),u.dataset.cameraPreset=m,u.dataset.cameraDistance=String(t)}o.render(s,c)}}}function fe(){return!d.selection||(d.active?![`body`,`station`].includes(d.selection.kind):[`body`,`station`].includes(d.selection.kind))?null:Hl(...d.selection.position)}function pe(){let e=fe();e&&(y=new oi(new oa(d.selection.kind===`system`?1.8:1.25,16,10),new Jr({color:7066597,wireframe:!0,depthTest:!1})),y.position.copy(e),y.renderOrder=10,s.add(y))}function me(){let e=Hl(d.ex.playerX(),d.ex.playerY(),d.ex.playerZ());u.dataset.activeGlowCount=`0`,u.dataset.activeStationCount=`0`,u.dataset.trialContactState=d.trial?d.trial.identified?`identified`:`unknown`:`idle`,u.dataset.trialGhostCount=String(d.trial?.ghosts.length||0),x.copy(e),b=new gn,b.position.copy(e),s.add(b),p&&b.add(new bo(d.viewRange*2,12,2180444,1519685));let t=new Bn(new V(-d.viewRange,-d.zRange,-d.viewRange),new V(d.viewRange,d.zRange,d.viewRange));b.add(new xo(t,5623781)),g=te(e),s.add(g),ue();let n=d.systemIds.length,r=[[],[],[],[],[]],i=0,a=0;for(let e=0;e<n;e++){let t=e*d.rows.systems,n=[d.systems[t],d.systems[t+1],d.systems[t+2]],o=Math.trunc(d.systems[t+3]),c=d.systemIds[e],l=d.discoveredSystemIds.has(c),u=d.objectiveTargetSystemIds.has(c);if(r[l&&o>=0&&o<Bl.length?o:l?3:4].push({kind:`system`,id:c,position:n,starClass:o,discovered:l,objective:u,priority:0,key:c.toString()}),l||i++,u){let e=new oi(new sa(2.35,.16,8,24),new Jr({color:16036959,depthTest:!1}));e.position.copy(Hl(...n)),e.rotation.x=Math.PI/2,e.renderOrder=8,s.add(e),a++}let f=Jl(...n,d.snapshot,d.rows.snapshot);if(f>0){let e=new oi(new oa(1.15,10,8),new Jr({color:f>=3?16744339:11599722,wireframe:!0,transparent:!0,opacity:.75}));e.position.copy(Hl(...n)),s.add(e)}}for(let e=0;e<r.length;e++){let t=r[e];if(!t.length)continue;let n=e===4,i=new vi(new oa(n?1.05:1.35,12,8),new Jr({color:n?Vl:Bl[e]??16777215,toneMapped:!1,transparent:n,opacity:n?.5:1}),t.length),a=new Vt;t.forEach((e,t)=>{let n=Hl(...e.position);a.makeTranslation(n.x,n.y,n.z),i.setMatrixAt(t,a)}),i.instanceMatrix.needsUpdate=!0,i.userData.kind=`stars`,i.userData.objects=t,_.push(i),v.push(i),s.add(i)}u.dataset.starCount=String(n),u.dataset.unknownContactCount=String(i),u.dataset.objectiveTargetCount=String(a);for(let e=0,t=0;e<d.snapshot.length;e+=d.rows.snapshot,t++){let n=d.snapshot[e+3];if(![0,1,2].includes(n))continue;let r=[d.snapshot[e],d.snapshot[e+1],d.snapshot[e+2]],i=n===0?Math.max(.8,d.snapshot[e+8]):.85,a=new oi(n===0?new oa(i,12,8):new ra(i),new Jr({color:n===0?12946431:Ul(d.snapshot[e+4],12946431),transparent:!0,opacity:n===0?.22:.9,wireframe:n===0}));a.position.copy(Hl(...r)),a.userData.object={kind:n===0?`anomaly`:n===1?`hazard`:`marker`,id:d.eventIds[t],position:r,priority:n===0?3:2,key:d.eventIds[t].toString()},s.add(a),v.push(a)}let o=0;for(let e=0,t=0;e<d.roamingContacts.length;e+=d.rows.roamingContacts,t++){let n=[d.roamingContacts[e],d.roamingContacts[e+1],d.roamingContacts[e+2]],r=t*d.rows.roamingContactIds,i=d.roamingContactIds[r],a=d.discoveredPoiIds.has(i),c=new oi(new na(a?1.15:1.4,1),new Jr({color:a?16036959:16744339,wireframe:!0,transparent:!0,opacity:a?.95:.6}));if(c.position.copy(Hl(...n)),c.userData.object={kind:`roaming contact`,id:i,position:n,known:a,velocity:[d.roamingContacts[e+3],d.roamingContacts[e+4],d.roamingContacts[e+5]],distress:d.roamingContacts[e+7]!==0,sourceBranchId:d.roamingContactIds[r+1],priority:1,key:i.toString()},s.add(c),v.push(c),a){let t=Hl(n[0]+d.roamingContacts[e+3]*30,n[1]+d.roamingContacts[e+4]*30,n[2]+d.roamingContacts[e+5]*30);s.add(new Fi(new vr().setFromPoints([c.position,t]),new Di({color:16036959})))}else o++}if(u.dataset.roamingContactCount=String(d.roamingContactIds.length/d.rows.roamingContactIds),u.dataset.unknownRoamingContactCount=String(o),d.trial){let e=Hl(...d.trial.position),t=new oi(new na(d.trial.identified?1.25:1.5,1),new Jr({color:d.trial.identified?16036959:16744339,wireframe:!0,transparent:!0,opacity:.9}));if(t.position.copy(e),t.rotation.set(performance.now()/850,performance.now()/1100,0),s.add(t),d.trial.identified){let t=Hl(d.trial.position[0]+d.trial.velocity[0]*30,d.trial.position[1]+d.trial.velocity[1]*30,d.trial.position[2]+d.trial.velocity[2]*30);s.add(new Fi(new vr().setFromPoints([e,t]),new Di({color:16036959})));for(let e of d.trial.ghosts){let t=new oi(new oa(.72,12,8),new Jr({color:7066597,wireframe:!0,transparent:!0,opacity:.55}));t.position.copy(Hl(...e)),s.add(t)}}}u.dataset.galaxyStationEventCount=String(v.filter(e=>e.userData.object?.kind===`station event`).length)}function he(){x.set(0,0,0);let e=0,t=0,n=[],r=[];S=12,p&&s.add(new bo(60,12,2180444,1519685));let i=[];for(let e=0;e<49;e++){let t=e/48*Math.PI*2;i.push(Hl(Math.cos(t)*64,Math.sin(t)*64,0))}let a=new Fi(new vr().setFromPoints(i),new xa({color:3233132,dashSize:2,gapSize:2}));a.computeLineDistances(),s.add(a),u.dataset.stationEscapeRadius=`64`;let o=d.ex.radiationSeverity();if(o>0){let e=new oi(new oa(26,20,14),new Jr({color:11599722,transparent:!0,opacity:Math.min(.3,.05+o*.08),wireframe:!0}));s.add(e),s.add(new Xa(11599722,Math.min(3,o),75))}for(let i=0,a=0;i<d.bodies.length;i+=d.rows.bodies,a++){let o=[d.bodies[i],d.bodies[i+1],d.bodies[i+2]],c=d.bodyIds[a],l=Math.max(c===0?2.8:.35,d.bodies[i+3]),u=Ul(d.bodies[i+4],c===0?16777182:9288948);t=Math.max(t,Math.hypot(...o)+l),c===0&&(S=Math.max(S,l*4));let f=new oi(new oa(l,18,12),c===0?new Jr({color:u,toneMapped:!1}):new va({color:u}));if(f.position.copy(Hl(...o)),f.userData.object={kind:`body`,id:c,position:o,priority:0,key:String(c)},s.add(f),v.push(f),n.push(f.position.x,f.position.y,f.position.z),r.push(u.r,u.g,u.b),c===0){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(64,64,4,64,64,64);r.addColorStop(0,`rgba(255,255,255,1)`),r.addColorStop(.2,`rgba(255,255,255,.8)`),r.addColorStop(1,`rgba(255,255,255,0)`),n.fillStyle=r,n.fillRect(0,0,128,128);let i=new Rr(new wr({map:new Ji(t),color:u,transparent:!0,blending:2,depthWrite:!1,toneMapped:!1,fog:!1}));i.position.copy(f.position),i.scale.setScalar(l*7),s.add(i),e++;let a=new Xa(u,6,140);a.position.copy(f.position),s.add(a)}}if(n.length){let e=new vr;e.setAttribute(`position`,new G(n,3)),e.setAttribute(`color`,new G(r,3)),s.add(new Gi(e,new Bi({size:3,sizeAttenuation:!1,vertexColors:!0,toneMapped:!1,fog:!1})))}let c=0;for(let e=0,n=0;e<d.stations.length;e+=d.rows.stations,n++){let r=[d.stations[e],d.stations[e+1],d.stations[e+2]];t=Math.max(t,Math.hypot(...r)+1);let i=new oi(new ra(.75),new Jr({color:Ul(d.stations[e+3],7066597),wireframe:!0})),a=d.stationEventIds[n],o=Gl(d,e,n);if(i.position.copy(Hl(...r)),i.userData.object={kind:`station`,id:a,position:r,priority:1,key:a.toString(),...o},s.add(i),v.push(i),o.lifecycle===`hosted`&&o.hostBodyId!==null){let e=d.bodyIds.indexOf(o.hostBodyId);if(e>=0){let t=e*d.rows.bodies,n=ql(r,new V(d.bodies[t],d.bodies[t+1],d.bodies[t+2]),o.orbitNormal,o.orbitRadius);n.length&&(s.add(new Fi(new vr().setFromPoints(n),new Di({color:7066597,transparent:!0,opacity:.35}))),c++)}}let l=Hl(...Kl(r,o.velocity));l.distanceToSquared(i.position)>0&&s.add(new Fi(new vr().setFromPoints([i.position,l]),new Di({color:16036959})))}C=Math.max(1e7,t*4),u.dataset.activeGlowCount=String(e),u.dataset.activeBodyPointCount=String(n.length/3),u.dataset.activeStationCount=String(d.stationEventIds.length),u.dataset.activeStationOrbitCount=String(c)}function ge(e){if(d=e,!f||!o||!d)return;let t=d.active?`system`:`galaxy`,n=x.clone();ee(),s.fog=d.active?null:new wn(527122,.0015),d.active?he():me(),c.far=d.active?C*1.25:3e3,c.updateProjectionMatrix(),s.add(new Qa(16777215,.8)),pe(),re(),se(),h===t?(!d.active||d.flight.mode===`keyboard`)&&c.position.add(x.clone().sub(n)):(c.position.copy(x).add(new V(d.active?36:55,d.active?30:48,d.active?36:55)),h=t),!d.active&&d.flight.mode===`nms`?de():c.lookAt(x),o.render(s,c)}function _e(e){d=e,!(!f||!g||d.active)&&(ue(),d.flight.mode===`nms`&&de(),re(),se(),o.render(s,c))}function ve(){if(!o)return;let t=Math.max(1,e.clientWidth),n=Math.max(1,e.clientHeight);o.setPixelRatio(Math.min(devicePixelRatio||1,innerWidth<=800?1.5:2)),o.setSize(t,n,!1),c.aspect=t/n,c.updateProjectionMatrix(),o.render(s,c)}function ye(e,t){let n=c.position.clone().sub(x);n.applyAxisAngle(new V(0,1,0),-e*.005);let r=new V().crossVectors(new V(0,1,0),n).normalize();n.applyAxisAngle(r,-t*.005),c.position.copy(x).add(n),c.lookAt(x),o.render(s,c)}function be(e){if(!d.active){a.setRanges(d.viewRange*e,d.zRange*e);return}let t=c.position.clone().sub(x);c.position.copy(x).add(t.setLength(Math.min(C,Math.max(S,t.length()*e)))),u.dataset.cameraDistance=String(c.position.distanceTo(x)),u.dataset.cameraMinDistance=String(S),u.dataset.cameraMaxDistance=String(C),c.lookAt(x),o.render(s,c)}function xe(e){let t=u.getBoundingClientRect();return{x:e.clientX,y:e.clientY,ndc:new B((e.clientX-t.left)/t.width*2-1,-(e.clientY-t.top)/t.height*2+1)}}function Se(e){let t=xe(e);l.setFromCamera(t.ndc,c);let n=l.intersectObjects(v,!1).map(e=>{let t=e.object.userData.kind===`stars`?e.object.userData.objects[e.instanceId]:e.object.userData.object;return t?{object:t,distance:e.distance}:null}).filter(Boolean);return n.sort((e,t)=>e.object.priority-t.object.priority||e.distance-t.distance||e.object.key.localeCompare(t.object.key)),n[0]?.object||null}function Ce(e){let t=xe(e);l.setFromCamera(t.ndc,c);let n=new Si(new V(0,1,0),-d.ex.playerZ()),r=l.ray.intersectPlane(n,new V);return r?[r.x,-r.z,r.y]:null}function we(e){O.delete(e.pointerId),u.hasPointerCapture(e.pointerId)&&u.releasePointerCapture(e.pointerId),O.size<2&&(k=null)}function Te(e,n=``){f=e&&!!o,localStorage.setItem(`multiverse-view`,f?`3d`:`2d`),u&&(u.hidden=!f),i.setVisible(!f),t.textContent=f?`Canvas fallback`:`enable Three.js`,n&&a.setStatus(n,!0),f&&(ve(),d&&ge(d))}try{o=new zl({antialias:!0,logarithmicDepthBuffer:!0,powerPreference:`high-performance`}),u=o.domElement,u.className=`three-space`,u.setAttribute(`aria-label`,`Multiverse Three.js view`),e.append(u),u.dataset.uShiftEffect=`idle`,u.dataset.uShiftShellCount=`0`,u.dataset.scanEffect=`idle`,u.dataset.scanRingCount=`0`,s=new Tn,s.background=new W(527122),c=new Ja(48,1,.1,3e3),c.position.set(55,48,55),l=new _o,new B,u.addEventListener(`pointerdown`,e=>{let t=xe(e);if(O.set(e.pointerId,t),A=!1,u.setPointerCapture(e.pointerId),O.size===2){let e=[...O.values()];k={distance:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),x:(e[0].x+e[1].x)/2,y:(e[0].y+e[1].y)/2}}}),u.addEventListener(`pointermove`,e=>{let t=O.get(e.pointerId);if(!t||!d)return;let n=xe(e);if(O.set(e.pointerId,n),O.size>=2){let e=[...O.values()],t=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),n=(e[0].x+e[1].x)/2,r=(e[0].y+e[1].y)/2;k&&(ye(n-k.x,r-k.y),Math.abs(t-k.distance)>3&&be(k.distance/t)),k={distance:t,x:n,y:r},A=!0;return}let r=n.x-t.x,i=n.y-t.y;Math.hypot(r,i)<=0||(A||=Math.hypot(r,i)>2,d.active||d.flight.mode===`keyboard`||e.button===2||e.buttons&2?ye(r,i):a.steer(-r*.005,-i*.004))}),u.addEventListener(`pointerup`,we),u.addEventListener(`pointercancel`,we),u.addEventListener(`contextmenu`,e=>e.preventDefault()),u.addEventListener(`click`,e=>{if(A||!d)return;let t=Se(e);if(t)a.selectObject(t);else if(!d.active&&d.clickMode===`marker`){let t=Ce(e);t&&a.placeMarker(t)}}),u.addEventListener(`dblclick`,e=>{let t=Se(e);t?.kind===`system`&&(a.selectObject(t),t.discovered&&a.enterSystem(t.id))}),u.addEventListener(`wheel`,e=>{e.preventDefault(),be(e.deltaY<0?1/1.2:1.2)},{passive:!1}),u.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),Te(!1,`WebGL context lost; Canvas fallback enabled`)}),t.onclick=()=>Te(!f),n.textContent=`grid: ${p?`on`:`off`}`,n.onclick=()=>{p=!p,localStorage.setItem(`multiverse-grid`,p?`on`:`off`),n.textContent=`grid: ${p?`on`:`off`}`,d&&ge(d)};for(let e of r)e.onclick=()=>M(e.dataset.cameraDistance);M(m),ve(),Te(f)}catch(e){f=!1,t.disabled=!0,i.setVisible(!0),a.setStatus(`WebGL unavailable; Canvas fallback enabled (${e.message})`,!0)}return{render:ge,resize:ve,updateFlight:_e,playUniverseShift:ie,playDiscoveryScan:ce,setEnabled:Te}}var J=e=>document.getElementById(e),Xl=new TextDecoder,Y={status:J(`status`),demoBuild:J(`demo-build`),readout:J(`readout`),tickReadout:J(`tick-readout`),statePanel:J(`state-panel`),hudU:J(`hud-u`),hudTick:J(`hud-tick`),branchTree:J(`branch-tree`),branchDetails:J(`branch-details`),events:J(`events`),stations:J(`stations`),effectAudit:J(`effect-audit`),objectDetails:J(`object-details`),bodyInspector:J(`body-inspector`),bodyDetails:J(`body-details`),enterSelected:J(`enter-selected`),catchUp:J(`catch-up`),catchUpProgress:J(`catch-up-progress`),galaxyControls:J(`galaxy-controls`),u:J(`u`),tickRate:J(`tick-rate`),tickRateLabel:J(`tick-rate-label`),autoTicks:J(`auto-ticks`),xyRange:J(`xy-range`),zRange:J(`z-range`),flightMode:J(`flight-mode`),flightHint:J(`flight-hint`),flightReadout:J(`flight-readout`),mode:J(`mode`),modeHint:J(`mode-hint`),fuelGauge:J(`fuel-gauge`),fuelText:J(`fuel-text`),energyGauge:J(`energy-gauge`),energyText:J(`energy-text`),shipStats:J(`ship-stats`),inventory:J(`inventory`),upgrades:J(`upgrades`),discoverySummary:J(`discovery-summary`),discoveries:J(`discoveries`),objective:J(`objective`),trialBriefing:J(`trial-briefing`),trialState:J(`trial-state`),trialTelemetry:J(`trial-telemetry`)},X,Z={},Zl=new Float64Array,Ql=new BigUint64Array,$l=new BigUint64Array,eu=new Float64Array,tu=new BigUint64Array,nu=new Float64Array,ru=new Uint32Array,iu=new Float64Array,au=new BigUint64Array,ou=new Uint32Array,su=new Float64Array,cu=new BigUint64Array,lu=new Float64Array,uu=new BigUint64Array,du=new Float64Array,fu=new Float64Array,pu=[],mu=[],hu=new Set,gu=new Set,_u=new Set,vu=[],yu=new Map,bu=new Map,xu=0,Su=!1,Cu=null,Q=null,wu=100,Tu=100,Eu=`select`,Du=!1,Ou=!1,ku=null,Au=0,ju=0,Mu={};try{Mu=JSON.parse(localStorage.getItem(`multiverse-flight`)||`{}`)}catch{localStorage.removeItem(`multiverse-flight`)}var Nu=Number.isFinite(Mu.heading)?Mu.heading:Math.PI/2,Pu=Number.isFinite(Mu.pitch)?Mu.pitch:0,Fu=Number.isFinite(Mu.roll)?Mu.roll:0,Iu=Number.isFinite(Mu.speed)?Mu.speed:0,Lu=localStorage.getItem(`multiverse-flight-mode`)||`nms`,Ru=new Set,zu=new Set,Bu=30,Vu=600,Hu=6,Uu=[60,120,180],Wu=null,Gu=0,Ku=0,qu=0;function Ju(){return Wu?.phase===`running`}function Yu(e=X.globalTick()){let t=Math.max(0,Math.trunc(e-Wu.startTick));return Wu.startPosition.map((e,n)=>e+Wu.velocity[n]*t)}function Xu(){return[X.playerX(),X.playerY(),X.playerZ()]}function Zu(e,t){return Math.hypot(e[0]-t[0],e[1]-t[1],e[2]-t[2])}function Qu(){if(!Ju())return null;let e=Yu();return{identified:Wu.identified,position:e,velocity:Wu.velocity,ghosts:Wu.identified?Uu.map(e=>Yu(Wu.startTick+Math.min(Vu,Math.trunc(X.globalTick()-Wu.startTick)+e))):[],remainingTicks:Math.max(0,Vu-Math.trunc(X.globalTick()-Wu.startTick)),distance:Zu(Xu(),e)}}function $u(){let e=Wu&&!Ju()?Wu:null;if(J(`trial-start`).disabled=Ju()||X?.activeSystemOpen()!==0,J(`trial-cancel`).disabled=!Ju(),J(`trial-retry`).disabled=!e,Ju()){let e=Qu(),t=e.position[2]-X.playerZ(),n=Math.abs(t)<.5?`level`:t>0?`above`:`below`;Y.trialState.className=`hint trial-live`,Y.trialState.textContent=Wu.identified?`identified: follow the vector and future ghosts; no lead marker is provided`:`unknown signal: use scan surroundings before it leaves the window`,Y.trialTelemetry.textContent=`state          ${Wu.identified?`identified`:`unknown`}\ntick remaining ${e.remainingTicks}\ndistance       ${e.distance.toFixed(1)}\nALT            ${t>=0?`+`:``}${t.toFixed(1)} (${n})\nminimum        ${Wu.minimumDistance.toFixed(1)}\nfuel spent     ${(Wu.startFuel-X.shipFuel()).toFixed(1)}\nlead samples   ${Wu.leadSamples}`;return}if(e){let t=e.phase.toUpperCase();Y.trialState.className=`hint ${e.phase===`success`?`trial-success`:`trial-failure`}`,Y.trialState.textContent=`${t}: sandbox rolled back; retry uses the same deterministic scenario`,Y.trialTelemetry.textContent=`result         ${e.phase}\nelapsed ticks  ${e.elapsedTicks}\nminimum range  ${e.minimumDistance.toFixed(1)}\nfuel spent     ${e.fuelSpent.toFixed(1)}\nlead samples   ${e.leadSamples}\nworld state    restored`;return}Y.trialState.className=`hint`,Y.trialState.textContent=`idle: no world state is changed`,Y.trialTelemetry.textContent=`start a trial to show distance, fuel spent, and timing.`}function ed(){let e=Ju();for(let t of[`#new`,`#import`,`#download`,`#split`,`#advance`,`#survey`,`#shift`,`#u-back`,`#u-forward`,`[data-move]`,`#mode`,`#enter-selected`,`#step-system`,`#exit-system`,`#destroy-body`,`#destroy-body-catastrophically`,`#apply-impulse`,`#place-station`,`#branch-travel`,`#branch-sibling`,`#rescue`,`#install-u-drive`,`#auto-ticks`])for(let n of document.querySelectorAll(t))e&&!n.disabled?(n.disabled=!0,n.dataset.trialDisabled=`true`):!e&&n.dataset.trialDisabled===`true`&&(n.disabled=!1,delete n.dataset.trialDisabled)}function td(){if(!Ju())return;let e=Qu();Wu.minimumDistance=Math.min(Wu.minimumDistance,e.distance),e.distance<=Hu?nd(`success`):e.remainingTicks===0&&nd(`failure`)}function nd(e){if(!Ju())return;let t={phase:e,elapsedTicks:Math.trunc(X.globalTick()-Wu.startTick),minimumDistance:Wu.minimumDistance,fuelSpent:Wu.startFuel-X.shipFuel(),leadSamples:Wu.leadSamples,baselineFlight:Wu.baselineFlight,baseline:Wu.baseline};try{fd(t.baseline),Nu=t.baselineFlight.heading,Pu=t.baselineFlight.pitch,Fu=t.baselineFlight.roll,Iu=t.baselineFlight.speed,Q=null,Ou=!1,Wu={...t,baseline:null},Td(),$(e===`success`?`intercept complete; world restored`:e===`failure`?`contact lost; world restored`:`trial cancelled; world restored`)}catch(e){Wu=null,$(`trial rollback failed: ${e.message||String(e)}`,!0)}}async function rd(){if(!Ju())try{let e=performance.now()+5e3;for(;Du&&performance.now()<e;)await new Promise(requestAnimationFrame);if(Du)throw Error(`world operation did not finish before the trial start`);if(X.activeSystemOpen())throw Error(`exit the active system before starting a trial`);if(X.shipEnergy()<5)throw Error(`the trial requires 5 energy for scan surroundings`);if(X.globalTick()>2**53-1-Vu)throw Error(`global tick is too large for the browser trial`);$(`preparing intercept trial baseline`),await ud();let t=[Math.cos(Nu)*Math.cos(Pu),Math.sin(Nu)*Math.cos(Pu),Math.sin(Pu)],n=[-Math.sin(Nu),Math.cos(Nu),0],r=Xu().map((e,r)=>e+t[r]*48+n[r]*32);Wu={phase:`running`,baseline:new Uint8Array(X.memory.buffer,X.imagePtr(),X.imageLen()).slice(),baselineFlight:{heading:Nu,pitch:Pu,roll:Fu,speed:Iu},startTick:Math.trunc(X.globalTick()),startPosition:r,velocity:n.map(e=>e*-.18),identified:!1,startFuel:X.shipFuel(),minimumDistance:1/0,leadSamples:0},Y.autoTicks.checked=!1,qu=0,Gu=performance.now(),Ku=Gu,Td(),$(`intercept trial started; scan the unknown contact`),requestAnimationFrame(id)}catch(e){$(e.message||String(e),!0)}}function id(e){if(!Ju())return;let t=Math.min(e-Gu,250);Gu=e,qu+=t*Bu/1e3;let n=Math.floor(qu);if(n){qu-=n;try{od(X.advance(n)),td(),Ju()&&e-Ku>=100&&(Ku=e,Td())}catch(e){nd(`failure`),$(e.message||String(e),!0)}}Ju()&&requestAnimationFrame(id)}function $(e,t=!1){Y.status.textContent=e,Y.status.style.color=t?`#ff7f93`:``}function ad(){return Xl.decode(new Uint8Array(X.memory.buffer,X.lastErrorPtr(),X.lastErrorLen()))}function od(e){if(!e)throw Error(ad()||`WASM operation failed`)}var sd=new Promise((e,t)=>{let n=indexedDB.open(`multiverse-game`,1);n.onupgradeneeded=()=>n.result.createObjectStore(`worlds`),n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error)});async function cd(e){let t=(await sd).transaction(`worlds`,`readwrite`).objectStore(`worlds`);return new Promise((n,r)=>{let i=t.put(e,`default`);i.onsuccess=n,i.onerror=()=>r(i.error)})}async function ld(){let e=(await sd).transaction(`worlds`,`readonly`).objectStore(`worlds`);return new Promise((t,n)=>{let r=e.get(`default`);r.onsuccess=()=>t(r.result),r.onerror=()=>n(r.error)})}async function ud(){if(!Ou||!X)return;if(ku)return await ku,Ou?ud():void 0;let e=Au;ku=(async()=>{let t=X.imagePtr(),n=X.imageLen();od(t!==0||n===0),await cd(new Uint8Array(X.memory.buffer,t,n).slice().buffer),Au===e&&(Ou=!1)})();try{await ku}finally{ku=null}if(Ou)return ud()}function dd(){Ou=!0,Au++}function fd(e){let t=X.allocate(e.byteLength);if(!t)throw Error(`WASM allocation failed`);try{new Uint8Array(X.memory.buffer).set(new Uint8Array(e),t),od(X.importImage(t,e.byteLength))}finally{X.freeAllocation(t,e.byteLength)}}function pd(e,t,n){return t?new Float64Array(X.memory.buffer,e,t*n).slice():new Float64Array}function md(e,t,n=1){return t?new BigUint64Array(X.memory.buffer,e,t*n).slice():new BigUint64Array}function hd(e,t){vu=[],yu=new Map,bu=new Map;for(let n=0;n<e.length;n+=Z.branches){let r=n/Z.branches,i=t[r*Z.branchIds],a=t[r*Z.branchIds+1],o={id:i,parentId:a===18446744073709551615n?null:a,low:e[n+2],high:e[n+3],splitTick:Math.trunc(e[n+4]),lifecycle:Math.trunc(e[n+5]),origin:e[n+6]};vu.push(o),yu.set(o.id,o)}vu.sort((e,t)=>e.id<t.id?-1:+(e.id>t.id));for(let e of vu){if(e.parentId===null||!yu.has(e.parentId))continue;let t=bu.get(e.parentId)||[];t.push(e),bu.set(e.parentId,t)}for(let e of bu.values())e.sort((e,t)=>e.low-t.low||(e.id<t.id?-1:+(e.id>t.id)))}function gd(e){let t=document.createElement(`div`);t.className=`state-section`;for(let[n,r]of e){let e=document.createElement(`span`),i=document.createElement(`span`);e.textContent=n,i.textContent=r,i.className=`state-value`,t.append(e,i)}return t}function _d(){let e=new Set,t=new Set,n=yu.get(X.activeBranch());for(;n&&!t.has(n.id);)e.add(n.id),t.add(n.id),n=n.parentId===null?null:yu.get(n.parentId);return e}function vd(){let e=X.activeBranch();yu.has(Cu)||(Cu=e);let t=new Set,n=document.createDocumentFragment(),r=(i,a)=>{if(t.has(i.id))return;t.add(i.id);let o=document.createElement(`button`);o.className=`branch-row ${i.lifecycle===0?`active`:`historical`}${i.id===e?` current`:``}${i.id===Cu?` selected`:``}`,o.style.paddingLeft=`${7+a*14}px`,o.innerHTML=`<span class="branch-id">#${i.id}</span><span>${i.lifecycle===0?`active`:`history`}</span>`,o.onclick=()=>{Cu=i.id,vd()},n.append(o);for(let e of bu.get(i.id)||[])r(e,a+1)};for(let e of vu)(e.parentId===null||!yu.has(e.parentId))&&r(e,0);for(let e of vu)r(e,0);Su&&n.append(Object.assign(document.createElement(`p`),{className:`hint`,textContent:`showing ${vu.length} of ${xu} branches`})),Y.branchTree.replaceChildren(n);let i=yu.get(Cu),a=i&&bu.get(i.id)||[],o=i?.parentId===null?[]:(bu.get(i?.parentId)||[]).filter(e=>e.id!==i.id&&e.lifecycle===0);Y.branchDetails.textContent=i?`branch       #${i.id} / ${i.lifecycle===0?`active`:`historical`}\nparent       ${i.parentId===null?`none`:`#${i.parentId}`}\nchildren     ${a.length?a.map(e=>`#${e.id}`).join(`, `):`none`}\nsplit tick   ${i.splitTick}\nbranch U     ${i.low.toFixed(1)} .. ${i.high.toFixed(1)}\nreachable U  ${X.reachableULow().toFixed(1)} .. ${X.reachableUHigh().toFixed(1)}\ndrive range  ${X.effectiveUDriveRange().toFixed(1)}\n${i.lifecycle===0?`active leaf: travel available`:`read-only at split tick`}`:`no selected branch`,J(`branch-parent`).disabled=!i||i.parentId===null||!yu.has(i.parentId),J(`branch-left`).disabled=a.length===0,J(`branch-right`).disabled=a.length<2,J(`branch-travel`).disabled=!i||i.lifecycle!==0,J(`branch-sibling`).disabled=o.length===0,J(`branch-focus`).disabled=!i||i.id===e}function yd(e){let t=Q?.kind===`system`&&Q.discovered;if(Y.enterSelected.disabled=e||!t,!Q)Y.objectDetails.textContent=`select a star, event, body, or station`;else if(Q.kind===`system`&&!Q.discovered)Y.objectDetails.textContent=`UNKNOWN CONTACT\nID    ${Q.id}\nXYZ   ${Q.position.map(e=>e.toFixed(3)).join(`, `)}\n\nScan required before entry.`;else if(Q.kind===`system`)Y.objectDetails.textContent=`STAR SYSTEM\nID    ${Q.id}\nXYZ   ${Q.position.map(e=>e.toFixed(3)).join(`, `)}\nclass ${Q.starClass}\n\nDouble-click or press enter selected system.`;else if(Q.kind===`body`)Y.objectDetails.textContent=`SYSTEM BODY\nID    ${Q.id}\nXYZ   ${Q.position.map(e=>e.toFixed(3)).join(`, `)}`;else if(Q.kind===`station`){let e=Q.hostBodyId===null?`none`:`body ${Q.hostBodyId}`,t=Q.direction===0?`prograde`:`retrograde`,n=Math.hypot(...Q.position),r=Q.lifecycle===`hosted`?`hosted circular orbit`:`galaxy trajectory`;if(Q.lifecycle===`detached bound`){let e=1/0,t=`none`;for(let n=0;n<ru.length;n++){let r=n*Z.bodies,i=Math.hypot(Q.position[0]-nu[r],Q.position[1]-nu[r+1],Q.position[2]-nu[r+2])-nu[r+3];i<e&&(e=i,t=`body ${ru[n]}`)}r=`local ${n.toFixed(2)} / escape 64.00\nclearance ${t} ${e.toFixed(2)}`}Y.objectDetails.textContent=`STATION\nID        ${Q.id}\nlifecycle ${Q.lifecycle}\nhost      ${e}\nXYZ       ${Q.position.map(e=>e.toFixed(3)).join(`, `)}\nvelocity  ${Q.velocity.map(e=>e.toFixed(3)).join(`, `)}\norbit R   ${Q.orbitRadius.toFixed(3)}\ndirection ${t}\nstatus    ${r}\ndistress  ${Q.distress?`active`:`none`}`}else if(Q.kind===`roaming contact`){let e=Q.known?`ROAMING CONTACT`:`UNKNOWN CONTACT`,t=Q.known?`\nvelocity ${Q.velocity.map(e=>e.toFixed(3)).join(`, `)}\ndistress  ${Q.distress?`active`:`none`}\nsource    branch #${Q.sourceBranchId}`:`

Scan required to resolve velocity and distress signal.`;Y.objectDetails.textContent=`${e}\nID    ${Q.id}\nXYZ   ${Q.position.map(e=>e.toFixed(3)).join(`, `)}${t}`}else Y.objectDetails.textContent=`${Q.kind.toUpperCase()}\nXYZ   ${Q.position.map(e=>e.toFixed(3)).join(`, `)}`;let n=Q?.kind===`body`?Q.id:null,r=n===null?-1:ru.indexOf(n);Y.bodyInspector.hidden=!e,J(`destroy-body`).disabled=r<0,J(`destroy-body-catastrophically`).disabled=r<0,J(`apply-impulse`).disabled=r<0,Y.bodyDetails.textContent=r<0?`select a body in the active system`:`body ID  ${n}\nXYZ      ${nu[r*Z.bodies].toFixed(3)}, ${nu[r*Z.bodies+1].toFixed(3)}, ${nu[r*Z.bodies+2].toFixed(3)}\nradius   ${nu[r*Z.bodies+3].toFixed(3)}`;let i=J(`station-host`),a=Number(i.value);i.replaceChildren();for(let e=0;e<ru.length;e++){let t=ru[e],n=document.createElement(`option`);n.value=String(t),n.textContent=t===0?`body 0 (primary)`:`body ${t}`,i.append(n)}let o=n??a;ru.includes(o)&&(i.value=String(o)),i.disabled=!e||ru.length===0,xd()}function bd(){if(!X||X.activeSystemOpen()===0)return!1;let e=Number(J(`station-host`).value),t=ru.indexOf(e),n=Number(J(`station-radius`).value);if(t<0||!Number.isFinite(n)||n<=0)return!1;let r=t*Z.bodies;return n>nu[r+3]&&n<64}function xd(){J(`place-station`).disabled=!bd()}function Sd(){let e=X.shipFuel(),t=X.shipFuelCapacity(),n=X.shipEnergy(),r=X.shipEnergyCapacity();Y.fuelGauge.max=t,Y.fuelGauge.value=e,Y.fuelText.textContent=`${e.toFixed(1)} / ${t.toFixed(1)}`,Y.energyGauge.max=r,Y.energyGauge.value=n,Y.energyText.textContent=`${n.toFixed(1)} / ${r.toFixed(1)}`,Y.shipStats.textContent=`scan range    ${X.effectiveScanRange().toFixed(1)}\nU-drive range ${X.effectiveUDriveRange().toFixed(1)}\nreachable U   ${X.reachableULow().toFixed(1)} .. ${X.reachableUHigh().toFixed(1)}`;let i=du.length>=2&&Math.trunc(du[0])===0?Math.trunc(du[1]):0,a=fu.length>=2&&Math.trunc(fu[0])===0;Y.inventory.textContent=i?`U-drive module x${i}`:`inventory empty`,Y.upgrades.textContent=a?`U-drive level ${Math.trunc(fu[1])} installed`:`no upgrades installed`,J(`install-u-drive`).disabled=a||i===0,J(`scan-discoveries`).disabled=X.activeSystemOpen()!==0,Y.discoverySummary.textContent=`${hu.size} systems\n${gu.size} points of interest`,Y.discoveries.replaceChildren();for(let e of pu){let t=document.createElement(`li`);t.textContent=`${e.kind===0?`system`:`POI`} ${e.objectId} / branch ${e.branchId} / tick ${e.tick}`,Y.discoveries.append(t)}let o=mu.find(e=>e.status===0)||mu[0];if(!o)Y.objective.textContent=`no active objective`;else{let e=o.targetEventId!==null&&gu.has(o.targetEventId),t=o.status===1?`COMPLETED at tick ${o.completedTick}`:`ACTIVE`,n=e&&o.targetBranchId!==null?`\ntarget branch  #${o.targetBranchId}`:`
branch         find surviving branch`;Y.objective.textContent=`${t}\nfind surviving station\ntarget SystemId ${o.targetSystemId}${n}`}}function Cd(e){let t=X.playerX(),n=X.playerY(),r=X.playerZ(),i=X.playerU(),a=X.catchUpTaskPending()!==0;Y.catchUp.hidden=!a,a&&(Y.catchUpProgress.textContent=`catching up: ${Math.trunc(X.catchUpTaskCompleted())} / ${Math.trunc(X.catchUpTaskTotal())} ticks`),Y.u.value=i.toFixed(4),Y.hudU.textContent=i.toFixed(4),Y.hudTick.textContent=X.globalTick().toFixed(0),Y.readout.textContent=`branch  ${X.activeBranch()}\ntick    ${X.globalTick().toFixed(0)}\nXYZ     ${t.toFixed(2)}, ${n.toFixed(2)}, ${r.toFixed(2)}\nU       ${i.toFixed(4)}\nU reach ${X.reachableULow().toFixed(1)} .. ${X.reachableUHigh().toFixed(1)}\ndrive   ${X.effectiveUDriveRange().toFixed(1)}\npages   ${X.blocksAllocated()}\nsystems ${eu.length/Z.systems}\nevents  ${Zl.length/Z.snapshot}\nactive  ${a?`catch-up pending`:e?`${nu.length/Z.bodies} bodies`:`galaxy map`}`,Y.tickReadout.textContent=`global tick  ${X.globalTick().toFixed(0)}\nmode         ${a?`catch-up pending`:e?`active system`:`galaxy map`}`;let o=e?`${X.activeSystemX().toFixed(3)}, ${X.activeSystemY().toFixed(3)}, ${X.activeSystemZ().toFixed(3)}`:`none`;Y.statePanel.replaceChildren(gd([[`query XYZ`,`${wu.toFixed(1)} / ${Tu.toFixed(1)}`],[`visible stars`,String(tu.length)],[`saved systems`,String(X.savedSystemsCount())],[`visible events`,String(Zl.length/Z.snapshot)],[`page image`,`${X.blocksAllocated()} pages`]]),gd([[`player XYZU`,`${t.toFixed(3)}, ${n.toFixed(3)}, ${r.toFixed(3)}, ${i.toFixed(4)}`],[`active branch`,String(X.activeBranch())],[`global tick`,X.globalTick().toFixed(0)]]),gd([[`active system`,o],[`active bodies`,String(e?nu.length/Z.bodies:0)],[`radiation`,e?X.radiationSeverity().toFixed(2):`none`],[`stations`,String(iu.length/Z.stations)]])),Y.galaxyControls.querySelectorAll(`input,select,button`).forEach(t=>{t.disabled=e}),Y.galaxyControls.style.opacity=e?`.45`:``,J(`step-system`).disabled=!e||nu.length===0,J(`exit-system`).disabled=!e,vd(),yd(e),Sd(),$u(),ed();let s=_d();Y.events.replaceChildren();for(let e=0;e<Zl.length;e+=Z.snapshot){let t=document.createElement(`li`),n=[`anomaly`,`hazard`,`marker`,`destroy body`,`change orbit`,`station`][Zl[e+3]]||`event`,r=e/Z.snapshot,i=$l[r],a=i===X.activeBranch()?`owned`:s.has(i)?`inherited`:`range match`;t.textContent=`${n} #${Ql[r]} @ (${Zl[e].toFixed(1)}, ${Zl[e+1].toFixed(1)}, ${Zl[e+2].toFixed(1)}) / branch ${i} / ${a}${n===`anomaly`?` / radius ${Zl[e+8].toFixed(1)} / strength ${Zl[e+9].toFixed(2)}`:``}`,Y.events.append(t)}Y.stations.replaceChildren();for(let e=0;e<iu.length;e+=Z.stations){let t=e/Z.stations,n=document.createElement(`li`),r=[`hosted`,`detached bound`,`roaming`,`destroyed`][Math.trunc(iu[e+7])]||`unknown`,i=ou[t]===4294967295?`none`:`body ${ou[t]}`;n.textContent=`event #${au[t]} / ${r} / host ${i} / (${iu[e].toFixed(1)}, ${iu[e+1].toFixed(1)}, ${iu[e+2].toFixed(1)}) / #${Math.round(iu[e+3]).toString(16).padStart(6,`0`)}`,Y.stations.append(n)}Y.effectAudit.replaceChildren();for(let e=0;e<lu.length;e+=Z.effects){let t=document.createElement(`li`),n=[`anomaly`,`hazard`,`marker`,`destroy body`,`change orbit`,`station`][lu[e+1]]||`effect`,r=Math.trunc(lu[e+5]),i=e/Z.effects*Z.effectIds;t.textContent=`#${uu[i]} / ${n} / tick ${Math.trunc(lu[e+2])} / ${lu[e+6]?`owned`:`inherited`} branch ${uu[i+1]}${r<0?``:` / body ${r}`}`,Y.effectAudit.append(t)}}function wd(){return{ex:X,rows:Z,snapshot:Zl,eventIds:Ql,eventBranchIds:$l,systems:eu,systemIds:tu,bodies:nu,bodyIds:ru,stations:iu,stationEventIds:au,stationHostBodyIds:ou,roamingContacts:su,roamingContactIds:cu,effects:lu,discoveredSystemIds:hu,discoveredPoiIds:gu,objectiveTargetSystemIds:_u,active:X.activeSystemOpen()!==0,viewRange:wu,zRange:Tu,selection:Q,flight:{heading:Nu,pitch:Pu,roll:Fu,speed:Iu,mode:Lu},clickMode:Eu,trial:Qu()}}function Td(){od(X.snapshot(wu,Tu));let e=X.activeSystemOpen()!==0,t=X.snapshotCount(),n=pd(X.snapshotPtr(),t,Z.snapshot),r=md(X.eventIdsPtr(),t,Z.eventIds),i=md(X.eventBranchIdsPtr(),t,Z.eventBranchIds),a=X.systemsCount();eu=pd(X.systemsPtr(),a,Z.systems),tu=md(X.systemIdsPtr(),a,Z.systemIds),nu=pd(X.bodiesPtr(),X.bodiesCount(),Z.bodies),ru=X.bodiesCount()?new Uint32Array(X.memory.buffer,X.bodyIdsPtr(),X.bodiesCount()).slice():new Uint32Array;let o=pd(X.stationsPtr(),X.stationsCount(),Z.stations),s=md(X.stationEventIdsPtr(),X.stationsCount(),Z.stationEventIds),c=X.stationsCount()?new Uint32Array(X.memory.buffer,X.stationHostBodyIdsPtr(),X.stationsCount()).slice():new Uint32Array;su=pd(X.roamingContactsPtr(),X.roamingContactsCount(),Z.roamingContacts),cu=md(X.roamingContactIdsPtr(),X.roamingContactsCount(),Z.roamingContactIds),lu=pd(X.effectAuditPtr(),X.effectAuditCount(),Z.effects),uu=md(X.effectAuditIdsPtr(),X.effectAuditCount(),Z.effectIds),du=pd(X.inventoryPtr(),X.inventoryCount(),Z.inventory),fu=pd(X.upgradesPtr(),X.upgradesCount(),Z.upgrades);let l=X.discoveriesCount(),u=pd(X.discoveriesPtr(),l,Z.discoveries),d=md(X.discoveryObjectIdsPtr(),l,Z.discoveryObjectIds),f=md(X.discoveryBranchIdsPtr(),l,Z.discoveryBranchIds);pu=Array.from({length:l},(e,t)=>({kind:Math.trunc(u[t*Z.discoveries]),tick:Math.trunc(u[t*Z.discoveries+1]),canonicalU:u[t*Z.discoveries+2],objectId:d[t],branchId:f[t]})),hu=new Set(pu.filter(e=>e.kind===0).map(e=>e.objectId)),gu=new Set(pu.filter(e=>e.kind===1).map(e=>e.objectId)),iu=o,au=s,ou=c;let p=X.objectivesCount(),m=pd(X.objectivesPtr(),p,Z.objectives),h=md(X.objectiveTargetIdsPtr(),p,Z.objectiveTargetIds),g=18446744073709551615n;mu=Array.from({length:p},(e,t)=>{let n=t*Z.objectives,r=t*Z.objectiveTargetIds;return{id:Math.trunc(m[n]),kind:Math.trunc(m[n+1]),status:Math.trunc(m[n+2]),startedTick:Math.trunc(m[n+3]),completedTick:m[n+4]?Math.trunc(m[n+5]):null,targetSystemId:h[r],targetEventId:h[r+1]===g?null:h[r+1],targetBranchId:h[r+2]===g?null:h[r+2]}}),_u=new Set(mu.filter(e=>e.status===0).map(e=>e.targetSystemId));let _=Array.from({length:t},(e,t)=>t).filter(e=>{let t=Math.trunc(n[e*Z.snapshot+3]);return t===2||![0,1,5].includes(t)||gu.has(r[e])});Zl=new Float64Array(_.length*Z.snapshot),Ql=new BigUint64Array(_.length),$l=new BigUint64Array(_.length),_.forEach((e,t)=>{Zl.set(n.subarray(e*Z.snapshot,(e+1)*Z.snapshot),t*Z.snapshot),Ql[t]=r[e],$l[t]=i[e]});let v=X.branchesCount();if(hd(pd(X.branchesPtr(),v,Z.branches),md(X.branchIdsPtr(),v,Z.branchIds)),xu=X.branchesTotalCount(),Su=X.branchesTruncated()!==0,Q?.kind===`body`){let e=ru.indexOf(Q.id);Q=e<0?null:{...Q,position:[nu[e*Z.bodies],nu[e*Z.bodies+1],nu[e*Z.bodies+2]]}}if(Q?.kind===`station`){let e=au.indexOf(Q.id);if(e<0)Q=null;else{let t=e*Z.stations,n=[`hosted`,`detached bound`,`roaming`,`destroyed`][Math.trunc(iu[t+7])]||`unknown`;Q={...Q,position:[iu[t],iu[t+1],iu[t+2]],velocity:[iu[t+4],iu[t+5],iu[t+6]],lifecycle:n,hostBodyId:ou[e]===4294967295?null:ou[e],orbitRadius:iu[t+8],direction:Math.trunc(iu[t+9]),distress:iu[t+10]!==0}}}Q?.kind===`system`&&(Q=tu.includes(Q.id)?{...Q,discovered:hu.has(Q.id),objective:_u.has(Q.id)}:null),Cd(e),Fd.render(wd()),Id.render(wd())}async function Ed(e,t=`saved to IndexedDB`){if(!Du){if(Ju()){$(`intercept trial active; cancel it before changing the world`,!0);return}Du=!0;try{await e(),dd(),await ud(),Td(),$(typeof t==`function`?t():t)}catch(e){$(e.message||String(e),!0)}finally{Du=!1}}}function Dd(e){Q=e;let t=wd();yd(t.active),Fd.render(t),Id.render(t)}function Od(){Q?.kind!==`system`||!Q.discovered||kd(Q.id)}function kd(e){Ed(()=>{od(X.enterSystemById(e)),Q=null},()=>{let e=X.lastVisitFlags(),t=[];return e&1&&t.push(`station found`),e&2&&t.push(`objective completed`),e&4&&t.push(`U-drive module rewarded`),e&8&&t.push(`ship refueled and recharged`),X.catchUpTaskPending()?(requestAnimationFrame(Hd),`catch-up started${t.length?`; ${t.join(`; `)}`:``}`):t.length?`system entered; ${t.join(`; `)}`:`system entered`})}function Ad(e){Ed(()=>{let t=Number.parseInt(J(`color`).value,16);if(!Number.isInteger(t))throw Error(`color must be rrggbb hex`);od(X.marker(...e,t))})}function jd(e,t){if(wu=Math.min(250,Math.max(10,Number(e))),Tu=Math.min(250,Math.max(1,Number(t))),!Number.isFinite(wu)||!Number.isFinite(Tu))throw Error(`query ranges must be finite`);Y.xyRange.value=wu,Y.zRange.value=Tu,Td()}function Md(e,t,n){if(!X||X.activeSystemOpen()||Du||document.hidden)return!1;if(od(X.flyBy(e,t,n)),Ju()){let e=Qu();(Wu.identified?Math.min(...e.ghosts.map(e=>Zu(Xu(),e))):1/0)<e.distance&&Wu.leadSamples++,td()}else dd();let r=performance.now();return r-ju>=100&&(ju=r,Td()),!0}function Nd(e,t){Nu+=e,Pu=Math.max(-Math.PI/3,Math.min(Math.PI/3,Pu+t)),Id.updateFlight(wd())}var Pd={selectObject:Dd,enterSelected:Od,enterSystem:kd,placeMarker:Ad,setRanges:jd,fly:Md,steer:Nd,setStatus:$,getState:wd},Fd=s(J(`space`),Pd),Id=Yl(J(`space-wrap`),J(`view-toggle`),J(`grid-toggle`),document.querySelectorAll(`[data-camera-distance]`),Fd,Pd);function Ld(e){for(let t of document.querySelectorAll(`.panel-tab`)){let n=t.dataset.panel===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}for(let t of document.querySelectorAll(`.panel-view`))t.hidden=t.dataset.panelView!==e;localStorage.setItem(`multiverse-panel`,e)}for(let e of document.querySelectorAll(`.panel-tab`))e.onclick=()=>Ld(e.dataset.panel);Ld(localStorage.getItem(`multiverse-panel`)||`branches`),document.addEventListener(`pointerup`,e=>{let t=e.target instanceof Element?e.target.closest(`button`):null;t&&t.blur()});function Rd(){return yu.get(Cu)}J(`new`).onclick=()=>Ed(()=>{od(X.format(Math.random()*4294967295>>>0)),Cu=null,Q=null}),J(`split`).onclick=()=>Ed(()=>{od(X.split()),Cu=X.activeBranch()}),J(`advance`).onclick=()=>Ed(()=>od(X.activeSystemOpen()?X.advanceSystem(1):X.advance(1))),J(`survey`).onclick=()=>Ed(()=>od(X.surveyAnomalies(wu)),()=>`survey resolved ${X.lastSurveyCount()} anomalies`);function zd(){if(X.activeSystemOpen())return $(`exit the active system to scan surroundings`,!0);if(Ju()){try{if(od(X.scanDiscoveries()),Qu().distance>X.effectiveScanRange())throw Error(`distress contact is outside scan range`);Wu.identified=!0,Id.playDiscoveryScan(X.effectiveScanRange()),Td(),$(`distress contact identified; read the vector and future ghosts`)}catch(e){$(e.message||String(e),!0)}return}if(Q?.kind===`roaming contact`){let e=cu.findIndex((e,t)=>cu[t*Z.roamingContactIds]===Q.id);if(e<0)Q=null;else{let t=e*Z.roamingContacts,n=e*Z.roamingContactIds;Q={...Q,position:[su[t],su[t+1],su[t+2]],velocity:[su[t+3],su[t+4],su[t+5]],known:gu.has(cu[n]),distress:su[t+7]!==0,sourceBranchId:cu[n+1]}}}Ed(()=>od(X.scanDiscoveries()),()=>(Id.playDiscoveryScan(X.effectiveScanRange()),`scan complete: ${X.lastScanNewSystems()} new systems, ${X.lastScanNewPointsOfInterest()} new points of interest; energy ${X.shipEnergy().toFixed(1)} / ${X.shipEnergyCapacity().toFixed(1)}`))}J(`scan-discoveries`).onclick=zd,J(`install-u-drive`).onclick=()=>Ed(()=>od(X.installUpgrade(0)),()=>`U-drive installed; effective range ${X.effectiveUDriveRange().toFixed(1)}`),J(`rescue`).onclick=()=>Ed(()=>{od(X.rescue()),Q=null,Iu=0},()=>`emergency rescue complete; fuel ${X.shipFuel().toFixed(1)}, energy ${X.shipEnergy().toFixed(1)}, +100 ticks`),J(`trial-start`).onclick=rd,J(`trial-cancel`).onclick=()=>nd(`cancelled`),J(`trial-retry`).onclick=rd;function Bd(e){let t=0;Ed(()=>{let n=X.playerU();od(X.shiftUniverse(e)),t=X.playerU()-n,Cu=X.activeBranch(),Q=null},()=>(Id.playUniverseShift(t),`shifted to U ${X.playerU().toFixed(4)}`))}J(`shift`).onclick=()=>Bd(Number(Y.u.value));function Vd(e){if(X.activeSystemOpen())return $(`exit the active system to navigate the galaxy`,!0);let t=Number(J(`u-step`).value);if(!Number.isFinite(t)||t<=0)return $(`U step must be positive`,!0);Bd(X.playerU()+e*t)}J(`u-back`).onclick=()=>Vd(-1),J(`u-forward`).onclick=()=>Vd(1);for(let e of document.querySelectorAll(`[data-move]`))e.onclick=()=>Ed(()=>{let t=Number(J(`step`).value);if(!Number.isFinite(t)||t<=0)throw Error(`move step must be positive`);let[n,r,i]=e.dataset.move.split(`,`).map(Number);od(X.moveBy(n*t,r*t,i*t))});Y.xyRange.onchange=()=>{try{jd(Y.xyRange.value,Tu)}catch(e){$(e.message,!0)}},Y.zRange.onchange=()=>{try{jd(wu,Y.zRange.value)}catch(e){$(e.message,!0)}},Y.mode.onclick=()=>{Eu=Eu===`select`?`marker`:`select`,Y.mode.textContent=`mode: ${Eu}`,Y.modeHint.textContent=Eu===`select`?`Select mode: click inspects a star; double-click enters it.`:`Marker mode: click empty space to create a branch-scoped XYZ marker.`,Td()},Y.enterSelected.onclick=Od,J(`step-system`).onclick=()=>Ed(()=>od(X.advanceSystem(8))),J(`exit-system`).onclick=()=>Ed(()=>{od(X.exitSystem()),Q=null}),J(`destroy-body`).onclick=()=>Ed(()=>od(X.destroyBody(Q.id))),J(`destroy-body-catastrophically`).onclick=()=>{!Q||!confirm(`Catastrophic destruction permanently destroys stations hosted by this body. Continue?`)||Ed(()=>od(X.destroyBodyCatastrophically(Q.id)),`body and hosted stations catastrophically destroyed`)};for(let e of[J(`station-host`),J(`station-radius`)])e.addEventListener(`input`,xd),e.addEventListener(`change`,xd);J(`apply-impulse`).onclick=()=>Ed(()=>{let e=[J(`impulse-x`),J(`impulse-y`),J(`impulse-z`)].map(e=>Number(e.value));if(e.some(e=>!Number.isFinite(e)))throw Error(`impulse components must be finite`);od(X.changeOrbit(Q.id,...e))}),J(`place-station`).onclick=()=>Ed(()=>{let e=Number(J(`station-host`).value),t=Number(J(`station-radius`).value),n=Number(J(`station-direction`).value),r=Number.parseInt(J(`station-color`).value,16);if(!Number.isInteger(e)||!Number.isFinite(t)||t<=0||![0,1].includes(n)||!Number.isInteger(r)||r<0||r>16777215)throw Error(`station host, orbit radius, direction, or color is invalid`);od(X.placeStationOnBody(e,t,n,r))}),J(`branch-parent`).onclick=()=>{let e=Rd();e?.parentId&&yu.has(e.parentId)&&(Cu=e.parentId,vd())},J(`branch-left`).onclick=()=>{let e=(bu.get(Cu)||[])[0];e&&(Cu=e.id,vd())},J(`branch-right`).onclick=()=>{let e=(bu.get(Cu)||[])[1];e&&(Cu=e.id,vd())},J(`branch-focus`).onclick=()=>{Cu=X.activeBranch(),vd()},J(`branch-travel`).onclick=()=>Ed(()=>{let e=Rd();if(!e||e.lifecycle!==0)throw Error(`SelectedBranchNotActive`);od(X.switchBranch(e.id)),Cu=X.activeBranch(),Q=null}),J(`branch-sibling`).onclick=()=>Ed(()=>{let e=Rd(),t=(bu.get(e?.parentId)||[]).find(t=>t.id!==e.id&&t.lifecycle===0);if(!t)throw Error(`NoActiveSibling`);od(X.switchBranch(t.id)),Cu=X.activeBranch(),Q=null}),J(`show-state`).onchange=e=>{Y.statePanel.hidden=!e.target.checked},Y.tickRate.oninput=()=>{Y.tickRateLabel.textContent=`${Y.tickRate.value} ticks / second`},Y.autoTicks.onchange=()=>{Y.autoTicks.checked||ud().catch(e=>$(e.message,!0))};function Hd(){if(Du||document.hidden)return;Du=!0;let e=()=>{if(document.hidden){Du=!1;return}try{od(X.advanceCatchUpTask()),dd(),Td(),X.catchUpTaskPending()?requestAnimationFrame(e):ud().then(()=>$(`catch-up complete`)).catch(e=>$(e.message,!0)).finally(()=>{Du=!1})}catch(e){Du=!1,$(e.message,!0)}};requestAnimationFrame(e)}J(`catch-up-run`).onclick=Hd,J(`catch-up-cancel`).onclick=()=>Ed(()=>od(X.cancelCatchUpTask()),`entry catch-up cancelled`),Y.flightMode.value=Lu;function Ud(){Y.flightHint.textContent=`${Lu===`nms`?`drag steer / W-S thrust-brake / A-D roll / Space boost / right-drag orbit / R-F vertical`:`W-S thrust-brake / A-D yaw / Space-C pitch / drag orbit / R-F vertical`} / Tab scan`}Ud(),Y.flightMode.onchange=()=>{Lu=Y.flightMode.value,Ru.clear(),localStorage.setItem(`multiverse-flight-mode`,Lu),Ud(),Td()};function Wd(e){return e.target instanceof Element&&!!e.target.closest(`input, select, textarea, button, a[href], [contenteditable]`)}window.addEventListener(`keydown`,e=>{if(Wd(e))return;let t=e.key.toLowerCase();if(t===`tab`){e.preventDefault(),e.repeat||zd();return}if([`w`,`a`,`s`,`d`,`c`,` `,`r`,`f`].includes(t)){e.preventDefault(),Ru.add(t);return}t===`q`&&(e.preventDefault(),Vd(-1)),t===`e`&&(e.preventDefault(),Vd(1)),t===`enter`&&Q?.kind===`system`&&Q.discovered&&Od()}),window.addEventListener(`keyup`,e=>Ru.delete(e.key.toLowerCase())),window.addEventListener(`blur`,()=>{Ru.clear(),zu.clear()});for(let e of document.querySelectorAll(`[data-flight]`)){let t=t=>{zu.delete(e.dataset.flight),e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId)};e.onpointerdown=t=>{t.preventDefault(),zu.add(e.dataset.flight),e.setPointerCapture(t.pointerId)},e.onpointerup=t,e.onpointercancel=t}J(`import`).onchange=async e=>{let t=e.target.files[0];if(t){try{fd(await t.arrayBuffer()),Cu=null,Q=null,dd(),await ud(),Td(),$(`imported ${t.name}`)}catch(e){$(e.message,!0)}e.target.value=``}},J(`download`).onclick=()=>{try{let e=new Uint8Array(X.memory.buffer,X.imagePtr(),X.imageLen()).slice(),t=Object.assign(document.createElement(`a`),{href:URL.createObjectURL(new Blob([e],{type:`application/octet-stream`})),download:`multiverse-world.mvg`});t.click(),setTimeout(()=>URL.revokeObjectURL(t.href),1e3)}catch(e){$(e.message,!0)}};var Gd=0,Kd=0,qd=0;function Jd(e){if(requestAnimationFrame(Jd),document.hidden||!X||Ju()||!Y.autoTicks.checked||Du){Gd=e,Kd=0;return}let t=Math.min(e-Gd,250);Gd=e,Kd+=t*Number(Y.tickRate.value)/1e3;let n=Math.floor(Kd);if(n){Kd-=n;try{od(X.activeSystemOpen()?X.advanceSystem(n):X.advance(n)),dd(),Td(),e-qd>=750&&(qd=e,ud().catch(e=>$(e.message,!0)))}catch(e){Y.autoTicks.checked=!1,$(e.message,!0)}}}var Yd=0,Xd=0,Zd=!1;function Qd(e){requestAnimationFrame(Qd);let t=Math.min((e-Yd)/1e3,.1);if(Yd=e,document.hidden||!X||X.activeSystemOpen()||Du)return;let n=Lu===`keyboard`,r=Ru.has(`w`)||zu.has(`thrust`),i=Ru.has(`s`)||zu.has(`brake`),a=(Ru.has(` `)||zu.has(`boost`))&&!n,o=!!Ru.has(`a`)-+!!Ru.has(`d`),s=(Ru.has(`r`)||zu.has(`up`)?1:0)-(Ru.has(`f`)||zu.has(`down`)?1:0);n?(Nu+=o*2.4*t,Pu=Math.max(-Math.PI/3,Math.min(Math.PI/3,Pu+(!!Ru.has(` `)-+!!Ru.has(`c`))*1.6*t)),Fu*=Math.max(0,1-2.5*t)):(Fu=Math.max(-Math.PI/2,Math.min(Math.PI/2,Fu-o*2.2*t)),o||(Fu*=Math.max(0,1-2.5*t))),r&&(Iu=Math.min(a?60:30,Iu+(a?30:12)*t)),i&&(Iu=Math.max(-8,Iu-30*t)),Iu*=Math.max(0,1-.55*t);let c=Math.cos(Pu)*Iu,l=Math.cos(Nu)*c*t,u=Math.sin(Nu)*c*t,d=(Math.sin(Pu)*Iu+s*16)*t,f=Math.abs(l)+Math.abs(u)+Math.abs(d)>=.001;Y.flightReadout.textContent=`flight: ${Iu.toFixed(1)} / ${a?60:30} / heading ${Math.round((Nu*180/Math.PI%360+360)%360)} / pitch ${Math.round(Pu*180/Math.PI)}`,localStorage.setItem(`multiverse-flight`,JSON.stringify({heading:Nu,pitch:Pu,roll:Fu,speed:Iu}));try{f&&Md(l,u,d),Id.updateFlight(wd()),Ou&&e-Xd>=750&&(Xd=e,ud().catch(e=>$(e.message,!0))),!f&&Zd&&(Td(),ud().catch(e=>$(e.message,!0)))}catch(e){Iu=0,$(e.message,!0)}Zd=f}document.addEventListener(`visibilitychange`,()=>{Ru.clear(),zu.clear(),Gd=performance.now(),Yd=performance.now(),document.hidden?ud().catch(e=>$(e.message,!0)):X&&Td()}),window.addEventListener(`resize`,()=>{Fd.resize(),Id.resize()});async function $d(){try{let t=await fetch(e);if(!t.ok)throw Error(`WASM request failed: ${t.status}`);let{instance:n}=await WebAssembly.instantiate(await t.arrayBuffer(),{});if(X=n.exports,Y.demoBuild.textContent=Xl.decode(new Uint8Array(X.memory.buffer,X.demoBuildPtr(),X.demoBuildLen())),Z={snapshot:X.snapshotRowWidth(),branches:X.branchesRowWidth(),systems:X.systemsRowWidth(),bodies:X.bodiesRowWidth(),stations:X.stationsRowWidth(),roamingContacts:X.roamingContactsRowWidth(),roamingContactIds:X.roamingContactIdsRowWidth(),effects:X.effectAuditRowWidth(),effectIds:X.effectAuditIdsRowWidth(),inventory:X.inventoryRowWidth(),upgrades:X.upgradesRowWidth(),discoveries:X.discoveriesRowWidth(),objectives:X.objectivesRowWidth(),eventIds:X.eventIdsRowWidth(),eventBranchIds:X.eventBranchIdsRowWidth(),branchIds:X.branchIdsRowWidth(),systemIds:X.systemIdsRowWidth(),stationEventIds:X.stationEventIdsRowWidth(),discoveryObjectIds:X.discoveryObjectIdsRowWidth(),discoveryBranchIds:X.discoveryBranchIdsRowWidth(),objectiveTargetIds:X.objectiveTargetIdsRowWidth()},X.abiVersion()!==3||X.abiCapabilities()!==255||Object.entries({snapshot:10,branches:7,systems:4,bodies:5,stations:14,roamingContacts:8,roamingContactIds:2,effects:7,effectIds:3,inventory:2,upgrades:2,discoveries:3,objectives:6,eventIds:1,eventBranchIds:1,branchIds:2,systemIds:1,stationEventIds:1,discoveryObjectIds:1,discoveryBranchIds:1,objectiveTargetIds:3}).some(([e,t])=>Z[e]!==t))throw Error(`Unsupported WASM snapshot ABI`);let r=await ld();if(r)try{fd(r),$(`restored IndexedDB world`)}catch{let e=r instanceof ArrayBuffer?new Uint8Array(r):new Uint8Array(r.buffer,r.byteOffset,r.byteLength),t=e.byteLength>=6&&new DataView(e.buffer,e.byteOffset,e.byteLength).getUint32(0,!0)===826758989&&new DataView(e.buffer,e.byteOffset,e.byteLength).getUint16(4,!0)===10;od(X.format(1)),dd(),await ud(),$(t?`saved image v10 is incompatible; reset and formatted v11`:`saved image was invalid; created a new world`,!0)}else od(X.format(1)),dd(),await ud(),$(`new world saved to IndexedDB`);Fd.resize(),Id.resize(),Td()}catch(e){$(e.message||String(e),!0)}}requestAnimationFrame(Jd),requestAnimationFrame(Qd),$d();